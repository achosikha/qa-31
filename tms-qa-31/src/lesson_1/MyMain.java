...
// lesson_1.MyMain.java - любой документ с таким расширением автоматически является исходным/рабочик кодом
...
// он превратил ваш обычный код в байт-код, создал документ типа - lesson_1.MyMain.class
// Компьютер будет выводить результат работы документа lesson_1.MyMain.class
...
// большой буквы: lesson_1.MyMain, MyHouse, StaffMember
